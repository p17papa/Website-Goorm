...
<head>
	...
	<style>
		...
		h4 a{
		background: linear-gradient(90deg, #8d96ff, #ffa9f9, #8d96ff);
		color: transparent;
...
<body>
	<div class="topnav">
		<link rel="stylesheet" type="text/css" href="topnavS.css">
        <a href="indexOFF.php" class="search_logo" style="background-color: transparent; ">
            <img src="stack-removebg-preview.png" width="250" height="auto">
        </a>
        <!-- <a href="homeOFF.php">Home</a>
        <a href="indexOFF.php">About</a> -->
	<a class="<?php if ($current_page == 'home') {echo 'active';} ?>" href="homeOFF.php">Home</a>
    <a class="<?php if ($current_page == 'about') {echo 'active';} ?>" href="indexOFF.php">About</a>
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.bundle.min.js" integrity="sha384-geWF76RCwLtnZ8qwWowPQNguL3RmwHVBC9FhGdlKrxdiJJigb/j/68SIy3Te4Bkz" crossorigin="anonymous"></script>
	...
	<h4>
		Make sure if you want to submit a question or answer to a previous posted question you need to create an <a href="https://webstuff.run-eu-central1.goorm.site/my_repo/register.php">account</a>.
	</h4>
